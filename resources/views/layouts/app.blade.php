...
<head>
    ...
    <title>{{ config('app.name', 'RUJAK') }} | @yield('title', 'Dashboard')</title>
...
<div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: true }">
    ...
    {{-- SIDEBAR --}}
    <aside class="flex flex-col bg-gray-900 text-white shrink-0 transition-all duration-300 overflow-hidden"
        ...
        {{-- Navigasi --}}
        <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto overflow-x-hidden whitespace-nowrap">
        ...
        {{-- User Info --}}
        <div class="px-4 py-4 border-t border-gray-700 whitespace-nowrap">
